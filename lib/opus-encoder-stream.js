...
var Encoder = function(rate, channels, frameSize) {
  Writable.call(this, { readableObjectMode: true });
...
util.inherits(Encoder, Writable);

/**
 * write stream callback
 */
Encoder.prototype._write = function(buf, encoding, done) {
  // Transform the buffer
  this._pushEncodedBuffer(buf, done);
...
Encoder.prototype._pushEncodedBuffer = function(encoded, end) {
  ...
  // (packet.bytes = encoded.length), (packet.b_o_s = 0);
  packet.e_o_s = 0;
